    ...
    <>
      ...
      <List size="huge" animated>
        <List.Item>
          ...
          <List.Content>
            <List.Header onClick={() => showPasswordFields(!passwordFields)} as="a" content="Update Password" />
          </List.Content>

          {passwordFields && <UpdatePassword setSuccess={setSuccess} showPasswordFields={showPasswordFields} />}
        </List.Item>
        <Divider />
        ...
        <List.Item>
          ...
          <List.Content>
            <List.Header onClick={() => showNewMessageSettings(!newMessageSettings)} as="a" content="Show New Message Popup?" />
          </List.Content>
          ...
          <div style={{ marginTop: "10px" }}>
            ...
            <br />
            <br />
            <Checkbox checked={popupSetting} toggle onChange={() => toggleMessagePopup(setPopupSetting, setSuccess)} />
          </div>
        </List.Item>
