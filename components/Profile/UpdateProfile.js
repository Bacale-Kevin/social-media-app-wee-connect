...
const UpdateProfile = ({ Profile }) => {
  ...
  return (
    <>
      ...
      >
        <Message onDismiss={() => setErrorMsg(null)} error content={errorMsg} attached header="Oops!" />
        ...
        <Button color="blue" icon="pencil alternate" disabled={profile.bio === "" || loading} content="Submit" type="submit" />
      </Form>
    </>
  );
}
